...
const dummyNotifications = [
  {
    ...
    message: "Block requisition for Maths for Class 3 is pending approval.",
    date: "2024-06-02",
    read: false,
  },
  {
    id: 2,
    type: "Block Request",
    message: "New request from Block B - North.",
    date: "2024-06-01",
    read: false,
  },
  {
    id: 3,
    type: "Info",
    message: "District meeting scheduled for 8th June.",
    date: "2024-05-30",
    read: true,
  },
];
...
const typeIcons = {
  "Block Request": <FilePlus2 className="h-4 w-4 text-blue-500" />,
