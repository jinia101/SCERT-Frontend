...
const dummyNotifications = [
  {
    ...
    message: "Your requisition for Maths for Class 3 has been approved.",
    date: "2024-06-02",
    read: false,
  },
  {
    id: 2,
    type: "Stock Arrival",
    message: "New stock of Science Explorer received.",
    date: "2024-06-01",
    read: false,
  },
  {
    id: 3,
    type: "Info",
    message: "Private school will be closed on 5th June for maintenance.",
    date: "2024-05-30",
    read: true,
  },
];
...
const typeIcons = {
  ...
  "Requisition Status": <FilePlus2 className="h-4 w-4 text-blue-500" />,
  Info: <Info className="h-4 w-4 text-yellow-500" />,
};

export default function PrivateSchoolNotifications() {
  ...
  return (
    <AdminLayout
      title="Private School Notifications"
      description="Stay updated with the latest requisition status, stock arrivals, and more for your private school"
      adminLevel={null}
    >
