...
const dummyAccounts = [
  { id: 1, username: "schooladmin", role: "Admin" },
  { id: 2, username: "teacher1", role: "Teacher" },
  { id: 3, username: "librarian", role: "Librarian" },
];

export default function SchoolLoginCredentials() {
  return (
    <AdminLayout
      title="Login Credentials"
      description="Manage user accounts for your school"
